...
2.The DB which is used is mysql databse, when APP is loaded, the app will create a database "test" ,and a new table "costumer1" will be created.
3.The pass word for local host of DB is "123456" which can be changed according to developer's local DB setting.
